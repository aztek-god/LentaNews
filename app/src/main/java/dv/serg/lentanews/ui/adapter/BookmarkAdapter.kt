...
abstract class BookmarkAdapter(val mData: MutableList<Bookmark> = ArrayList(), private val clickListener: (view: View, position: Int) -> Unit = { _, _ -> run {} },
                               private val longListener: (view: View, position: Int) -> Unit = { _, _ -> run {} }, val mutableData: MutableList<Bookmark>)
    : AbstractAdapter<Bookmark, BookmarkAdapter.ViewHolder>() {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(bookmark: Bookmark, clickListener: (view: View, position: Int) -> Unit = { _, _ -> run {} }, longListener: (view: View, position: Int) -> Unit = { _, _ -> run {} }) {
            ...
            with(bookmark) {
                ...
                bookmarkDesc.text = shortDesc
                bookmarkDatetime.text = addedAt
            }
        }
    }
}